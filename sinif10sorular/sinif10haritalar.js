...
window.HARITA_MOTORU["harita_u2_rumeli_10"] = function() {
    ...
    controlsContainer.innerHTML = `
        <div style="text-align: center; color: #F4E4B0; display: flex; flex-direction: column; align-items: center; gap: 8px;">
            ...
            <p style="font-size: 0.85em; opacity: 0.8;">Fatih'in Boğazkesen stratejisi ve Karadeniz trafiğinin kesilmesi.</p>
        </div>
    `;
    controlsContainer.style.display = 'block';
...
// ==========================================
// 11. ARAÇ: İSKÂN POLİTİKASI YÖNETİCİSİ
// ==========================================
window.HARITA_MOTORU["harita_u2_arac_iskan_11"] = function() {
    ...
    controlsContainer.innerHTML = `
        <div style="text-align: center; color: #F4E4B0;">
            <h3 style="margin:0; color: #E8A020;">İskân Politikası Yöneticisi</h3>
            <p style="font-size: 0.85em; opacity: 0.8; margin:5px 0 0 0;">Yeni fethedilen Balkan topraklarını şenlendir ve Türkleştir!</p>
        </div>
    `;
    controlsContainer.style.display = 'block';
    ...
    mapCanvas.innerHTML = `
        <div id="iskanSimulator" style="width:100%; height:100%; background:#f1e7d0; color:#2c3e50; font-family:'Inter', sans-serif; display:flex; flex-direction:column; padding:15px; box-sizing:border-box; overflow-y:auto;">
            ...
            <div style="display:grid; grid-template-columns: 1fr 1fr 1fr; gap:10px; margin-bottom:15px;">
                <div style="background:#fff; padding:10px; border-radius:8px; border:2px solid #8B1A1A; text-align:center;">
                    <i class="fa-solid fa-users" style="color:#8B1A1A;"></i><br><small>Türk Nüfusu</small><br><b id="iskNufus">20</b>
                </div>
                <div style="background:#fff; padding:10px; border-radius:8px; border:2px solid #27ae60; text-align:center;">
                    <i class="fa-solid fa-wheat-awn" style="color:#27ae60;"></i><br><small>Üretim</small><br><b id="iskUretim">30</b>
                </div>
                <div style="background:#fff; padding:10px; border-radius:8px; border:2px solid #2980b9; text-align:center;">
                    <i class="fa-solid fa-dove" style="color:#2980b9;"></i><br><small>Huzur</small><br><b id="iskHuzur">50</b>
                </div>
            </div>
            ...
            <div style="background:#fff; border-left:5px solid #E8A020; padding:15px; border-radius:8px; margin-bottom:15px; box-shadow:0 4px 6px rgba(0,0,0,0.1);">
                <small style="color:#E8A020; font-weight:bold; text-transform:uppercase;">Filibe'de Yeni Bir Gün (Aşama <span id="iskAsama">1</span>/5)</small>
            ...
            <div style="margin-top:auto; font-size:10px; font-weight:bold; color:rgba(0,0,0,0.5); padding-top:10px;">Harita/Araç: Murat Mutlu</div>
        </div>
    `;

    window.ISKAN_MOTORU = {
        nufus: 20, uretim: 30, huzur: 50, asama: 0,
        senaryolar: [
            {
                t: "Yeni fethettiğimiz Filibe ovasına Anadolu'dan kimleri yerleştireceğiz?",
                o: [
                    { b: "Anadolu'da aralarında kan davası olan iki konar-göçer aileden birini getirelim.", d: {n: 20, u: 10, h: 20}, m: "Mükemmel! Hem Anadolu'daki çatışmayı çözdün hem de konar-göçerleri yerleşik hayata geçirerek üretimi başlattın." },
                    { b: "Şehirde esnaflık yapan zengin yerleşik aileleri zorla göç ettirelim.", d: {n: 10, u: -10, h: -20}, m: "Hatalı! İskân politikası yerleşik düzeni bozmaz, konar-göçerleri yerleşik hayata geçirmeyi hedefler. Huzur düştü." }
                ]
            },
            {
                t: "Gelen göçmen aileler yerleşmek için ev ve tohum istiyor. Ne yapalım?",
                o: [
                    { b: "Kendi başlarının çaresine baksınlar, devlet toprağı verdi zaten.", d: {n: -10, u: -20, h: -10}, m: "Yanlış karar! İskân edilenlere devlet tohum ve ziraat aletleri yardımı yapmak zorundadır. Göçmenler perişan oldu." },
                    { b: "Devlet hazinesinden tohum, ziraat aleti ve bir miktar vergi muafiyeti sağlayalım.", d: {n: 10, u: 30, h: 10}, m: "Doğru strateji! Geçici vergi muafiyeti (muafname) ve tohum desteği sayesinde tarım hızla canlandı." }
                ]
            },
            {
                t: "Göçmenlerden bir grup, verilen toprağı beğenmeyip Anadolu'ya geri dönmek istiyor.",
                o: [
                    { b: "İzin vermeyelim. İskân edilenlerin belli bir süre bölgeyi terk etmesi yasaktır.", d: {n: 10, u: 10, h: -5}, m: "Devlet kuralı uygulandı! Bölgenin Türkleşmesi ve savunması için geri dönüşler yasaktır. Biraz homurdansalar da düzen sağlandı." },
                    { b: "İsteyen dönebilir, zorla güzellik olmaz.", d: {n: -20, u: -10, h: 10}, m: "Büyük Hata! Eğer herkes dönerse fethedilen yerlerde kalıcı olamayız. Nüfus ve üretim düştü." }
                ]
            },
            {
                t: "Bölgedeki yerli Hristiyan halk ile yeni gelen Müslüman Türkler arasında arazi sınırı anlaşmazlığı çıktı.",
                o: [
                    { b: "Müslümanlar haklıdır, yerli halkın arazisini Türklere verelim.", d: {n: 10, u: 0, h: -30}, m: "Tehlikeli adım! İskân politikası ile İstimalet (Hoşgörü) birlikte yürümezse isyan çıkar. Huzur çok sert düştü." },
                    { b: "Kadı tayin edelim ve şer'i/örfi hukuka göre adil bir karar verilsin.", d: {n: 5, u: 10, h: 25}, m: "Adalet mülkün temelidir! Yerli halk, Osmanlı adaletine güven duymaya başladı." }
                ]
            },
            {
                t: "Bölge iyice şenlendi. Şimdi kurumsallaşma vakti. İlk ne inşa edelim?",
                o: [
                    { b: "Büyük bir askeri kışla ve zindan inşa edelim.", d: {n: 0, u: 0, h: -10}, m: "Askeri güç önemlidir ama İskân'ın amacı şehri yaşanabilir kılmaktır. Halk korkutuldu." },
                    { b: "Vakıf sistemiyle bir cami, medrese ve bedesten (çarşı) kuralım.", d: {n: 20, u: 20, h: 20}, m: "Harika! Cami ve çarşı etrafında gelişen Türk-İslam şehir modeli başarıyla uygulandı." }
                ]
            }
        ],
        ...
        guncelle: function() {
            if(this.asama >= 5) { this.bitir(); return; }
            const s = this.senaryolar[this.asama];
            
            document.getElementById('iskNufus').innerText = this.nufus;
            document.getElementById('iskUretim').innerText = this.uretim;
            document.getElementById('iskHuzur').innerText = this.huzur;
        ...
        kararVer: function(degisim, mesaj) {
            this.nufus += degisim.n; this.uretim += degisim.u; this.huzur += degisim.h;
            
            const gb = document.getElementById('iskGeriBildirim');
            if(degisim.h > 0 || degisim.u > 0) {
                gb.style.color = "#27ae60"; gb.innerHTML = `<i class='fa-solid fa-check'></i> ${mesaj}`;
            } else {
                gb.style.color = "#8B1A1A"; gb.innerHTML = `<i class='fa-solid fa-xmark'></i> ${mesaj}`;
            }
        ...
        bitir: function() {
            let basari = (this.nufus + this.uretim + this.huzur) / 3;
            let mesaj = basari >= 60 ? "Mükemmel Yönetim! Bölge tamamen Türkleşti ve şenlendi." : "Kısmi Başarı. Bölgede hala istikrarsızlık var.";
            document.getElementById('iskanSimulator').innerHTML = `
                <div style="text-align:center; padding:40px;">
                    <i class="fa-solid fa-city" style="font-size:4em; color:#E8A020;"></i>
                    <h2>İskân Tamamlandı</h2>
                    <p>${mesaj}</p>
                    <p>Genel Başarı Endeksi: <b style="color:#27ae60; font-size:1.5em;">%${Math.floor(basari)}</b></p>
                    <button onclick="window.HARITA_MOTORU['harita_u2_arac_iskan_11']()" style="padding:10px 20px; border:none; background:#2c3e50; color:#fff; border-radius:5px; cursor:pointer;">Yeni Bölgeye Geç</button>
                </div>
            `;
        }
    };
...
// ==========================================
// 12. ARAÇ: İSTİMALET (GÖNÜL ALMA) RADARI
// ==========================================
window.HARITA_MOTORU["harita_u2_arac_istimalet_12"] = function() {
    ...
    controlsContainer.innerHTML = `
        <div style="text-align: center; color: #F4E4B0;">
            <h3 style="margin:0; color: #E8A020;">İstimalet Radarı</h3>
            <p style="font-size: 0.85em; opacity: 0.8; margin:5px 0 0 0;">Balkan halkının gönlünü kazan, kalıcı ol!</p>
        </div>
    `;
    controlsContainer.style.display = 'block';
    ...
    mapCanvas.innerHTML = `
        <div id="istSimulator" style="width:100%; height:100%; background:#e4e9ed; color:#2c3e50; font-family:'Inter', sans-serif; display:flex; flex-direction:column; padding:15px; box-sizing:border-box; overflow-y:auto;">
            ...
            <div style="display:grid; grid-template-columns: 1fr 1fr 1fr; gap:10px; margin-bottom:15px;">
                <div style="background:#fff; padding:10px; border-radius:8px; border:2px solid #27ae60; text-align:center;">
                    <i class="fa-solid fa-handshake" style="color:#27ae60;"></i><br><small>Sadakat</small><br><b id="istSadakat">30</b>
                </div>
                <div style="background:#fff; padding:10px; border-radius:8px; border:2px solid #8B1A1A; text-align:center;">
                    <i class="fa-solid fa-fire" style="color:#8B1A1A;"></i><br><small>İsyan Riski</small><br><b id="istIsyan">40</b>
                </div>
                <div style="background:#fff; padding:10px; border-radius:8px; border:2px solid #C9A84C; text-align:center;">
                    <i class="fa-solid fa-coins" style="color:#C9A84C;"></i><br><small>Hazine</small><br><b id="istHazine">50</b>
                </div>
            </div>
            ...
            <div style="background:#fff; border-left:5px solid #2980b9; padding:15px; border-radius:8px; margin-bottom:15px; box-shadow:0 4px 6px rgba(0,0,0,0.1);">
                <small style="color:#2980b9; font-weight:bold; text-transform:uppercase;">Vaka <span id="istAsama">1</span>/5</small>
                <p id="istSenaryo" style="margin:10px 0 0 0; font-size:1em; font-weight:500; line-height:1.4;">Yükleniyor...</p>
            </div>

            <div id="istButonlar" style="display:flex; flex-direction:column; gap:10px;"></div>
            <div id="istGeriBildirim" style="margin-top:15px; text-align:center; font-weight:bold; min-height:40px;"></div>
    ...
    window.ISTIMALET_MOTORU = {
        sadakat: 30, isyan: 40, hazine: 50, asama: 0,
        senaryolar: [
            {
                t: "Bölgedeki Ortodoks Kilisesi rahipleri, vergilerini ödeyemediklerini söyleyip yardım istiyor.",
                o: [
                    { b: "Kiliselerin vergilerini bir süreliğine affet ve ibadet özgürlüğünü garanti altına al.", d: {s: 25, i: -20, h: -10}, m: "İstimaletin temeli! Hristiyan halk Osmanlı'nın adaletine hayran kaldı. İsyan riski azaldı." },
                    { b: "Kimseye ayrıcalık yok, vergisini vermeyenin kilisesi kapatılsın.", d: {s: -20, i: 30, h: 10}, m: "Hata! Bizans'ın baskısından kaçan halka aynısını yaparsan isyan kaçınılmazdır." }
                ]
            },
            {
                t: "Ordumuz sefere giderken bazı askerler yerli halkın ekinlerine zarar verdi.",
                o: [
                    { b: "Zararı hazineden karşıla ve ekinleri ezen askerleri cezalandır.", d: {s: 20, i: -15, h: -15}, m: "Büyük adalet! Halk, ordunun çapulcu değil düzenli bir devlet ordusu olduğunu gördü." },
                    { b: "Savaş zamanı olur böyle şeyler, büyütmeye gerek yok.", d: {s: -30, i: 25, h: 0}, m: "Güven sarsıldı! Halk Osmanlı'yı işgalci olarak görmeye başladı." }
                ]
            },
            {
                t: "Eski bir Bizans tekfuru, emrindeki köylülerle Osmanlı'ya itaat edeceğini bildirdi.",
                o: [
                    { b: "Eski gücünü kır, elindeki tüm toprakları al ve onu sürgüne gönder.", d: {s: -10, i: 20, h: 10}, m: "Diplomatik hata! Mevcut yerel güçleri aniden yok etmek bölgeyi kaosa sürükler." },
window.HARITA_MOTORU = window.HARITA_MOTORU || {};

// ==========================================
// 14. ARAÇ: DEVŞİRME VE KAPIKULU MOTORU
// ==========================================
window.HARITA_MOTORU["harita_u2_arac_devsirme_14"] = function() {
    ...
    controlsContainer.innerHTML = `
        <div style="text-align: center; color: #F4E4B0;">
            <h3 style="margin:0; color: #E8A020;">Devşirme - Kapıkulu Motoru</h3>
            <p style="font-size: 0.85em; opacity: 0.8; margin:5px 0 0 0;">Bir devşirme gencin kariyer yolculuğunu yönet.</p>
        </div>
    `;
    controlsContainer.style.display = 'block';
    ...
    mapCanvas.innerHTML = `
        <div id="devSimulator" style="width:100%; height:100%; background:#e9e4d4; color:#2c3e50; font-family:'Inter', sans-serif; display:flex; flex-direction:column; padding:15px; box-sizing:border-box; overflow-y:auto;">
            <div style="display:grid; grid-template-columns: 1fr 1fr 1fr; gap:10px; margin-bottom:15px;">
                <div style="background:#fff; padding:10px; border-radius:8px; border:2px solid #8B1A1A; text-align:center;">
                    <i class="fa-solid fa-dumbbell" style="color:#8B1A1A;"></i><br><small>Fiziksel Güç</small><br><b id="devGuc">10</b>
                </div>
                <div style="background:#fff; padding:10px; border-radius:8px; border:2px solid #2980b9; text-align:center;">
                    <i class="fa-solid fa-brain" style="color:#2980b9;"></i><br><small>Zeka / Eğitim</small><br><b id="devZeka">10</b>
                </div>
                <div style="background:#fff; padding:10px; border-radius:8px; border:2px solid #27ae60; text-align:center;">
                    <i class="fa-solid fa-medal" style="color:#27ae60;"></i><br><small>Liyakat (Sadakat)</small><br><b id="devLiyakat">10</b>
                </div>
            </div>
            <div style="background:#fff; border-left:5px solid #8B1A1A; padding:15px; border-radius:8px; margin-bottom:15px; box-shadow:0 4px 6px rgba(0,0,0,0.1);">
                <small style="color:#8B1A1A; font-weight:bold; text-transform:uppercase;">Aşama <span id="devAsama">1</span>/5</small>
    ...
    window.DEVSIRME_MOTORU = {
        guc: 10, zeka: 10, liyakat: 10, asama: 0,
        senaryolar: [
            {
                t: "Balkanlarda bir köy. Turnacıbaşı devşirme seçimi yapıyor. Ailenin tek erkek çocuğu musun, yoksa kardeşlerin var mı?",
                o: [
                    { b: "Ailenin tek erkek çocuğuyum.", d: {g: 0, z: 0, l: -50}, m: "Kanunnameye aykırı! Ailenin tek oğlu devşirilemez, soya zarar verilmez. Seçilmedin." },
                    { b: "İki erkek kardeşim daha var. Yaşım 12 ve sağlıklıyım.", d: {g: 10, z: 10, l: 10}, m: "Devşirme kanununa uygunsun! Kırmızı cübbe giydirilip İstanbul'a doğru yola çıkarıldın." }
                ]
            },
            {
                t: "İstanbul'a geldin. İlk olarak 'Türkmen Ailelerin Yanına' verileceksin. Neye odaklanacaksın?",
                o: [
                    { b: "Tarlada çok çalışıp vücudumu geliştirmeye odaklanacağım.", d: {g: 20, z: 5, l: 10}, m: "Gücün arttı! Türk İslam âdetlerini öğrendin ancak bedensel gelişimin öne çıktı." },
                    { b: "Daha çok Türkçe okumaya ve dini eğitim almaya odaklanacağım.", d: {g: 5, z: 20, l: 10}, m: "Zekan parlıyor! Türkçeyi ve İslamiyet'i kusursuz öğrendin." }
                ]
            },
            {
                t: "Acemi Ocağı'na (Gelibolu/İstanbul) alındın. Askeri eğitim başladı.",
                o: [
                    { b: "Kılıç, ok ve gürz talimlerinde en önde olmak istiyorum.", d: {g: 25, z: 0, l: 10}, m: "Müthiş bir savaşçı oluyorsun! Komutanların gücüne hayran kaldı." },
                    { b: "Talimlerin yanında hesap kitap ve devlet idaresi derslerini gizlice takip edeyim.", d: {g: 0, z: 25, l: 10}, m: "Acemi ocağındaki hocaların zekanı fark etti. Sıradan bir asker olmayacağın belli." }
                ]
            },
            {
                t: "Büyük gün geldi: 'Çıkma' (Bedargah) zamanı. Nereye seçileceksin?",
                o: [
                    { b: "Padişahın yakın koruması ve elit piyadesi olmak istiyorum.", d: {g: 15, z: 0, l: 20}, m: "Sadakatin tam! Yeniçeri Ocağı'na geçiş yaptın. Artık bir Yeniçerisin." },
                    { b: "Padişahın saray okulunda (Enderun) özel eğitim almak istiyorum.", d: {g: 0, z: 20, l: 20}, m: "Seçkin bir öğrenci oldun! Enderun Mektebi'ne (Saray Eğitim Kurumu) seçildin." }
                ]
            },
            {
                t: "Son görev: Devlet sana kritik bir vazife verdi.",
                o: [
                    { b: "Sınır boylarında sefere katılıp düşman kalelerini kuşatmak.", d: {g: 20, z: 0, l: 20}, m: "Savaş meydanında kahramanlık gösterdin!" },
                    { b: "Merkezde kalarak hazine defterlerini ve diplomasiyi yönetmek.", d: {g: 0, z: 20, l: 20}, m: "Devletin sır kâtibi ve yöneticisi oldun!" }
                ]
            }
        ],
        baslat: function() { this.guncelle(); },
        guncelle: function() {
            if(this.liyakat < 0 || this.asama >= 5) { this.bitir(); return; }
            const s = this.senaryolar[this.asama];
            
            document.getElementById('devGuc').innerText = this.guc;
            document.getElementById('devZeka').innerText = this.zeka;
            document.getElementById('devLiyakat').innerText = this.liyakat;
            document.getElementById('devAsama').innerText = this.asama + 1;
            document.getElementById('devSenaryo').innerText = s.t;
            document.getElementById('devGeriBildirim').innerHTML = "";
            ...
            s.o.forEach(opt => {
                const btn = document.createElement('button');
                btn.style.cssText = "padding:12px; border:none; border-radius:8px; background:#2c3e50; color:#fff; cursor:pointer; text-align:left; line-height:1.4;";
                btn.innerHTML = `<i class="fa-solid fa-chevron-right" style="color:#E8A020;"></i> ${opt.b}`;
                btn.onclick = () => this.kararVer(opt.d, opt.m);
                bKutu.appendChild(btn);
            });
        },
        kararVer: function(degisim, mesaj) {
            this.guc += degisim.g; this.zeka += degisim.z; this.liyakat += degisim.l;
            const gb = document.getElementById('devGeriBildirim');
            gb.style.color = degisim.l > 0 ? "#27ae60" : "#8B1A1A";
            gb.innerHTML = mesaj;
            document.getElementById('devButonlar').innerHTML = "";
            this.asama++;
            setTimeout(() => this.guncelle(), 2500);
        },
        bitir: function() {
            let sonuc, ikon;
            if(this.liyakat < 0) { sonuc = "Elendin! Köyüne geri gönderildin."; ikon = "fa-ban"; }
            else if(this.zeka > this.guc && this.zeka >= 60) { sonuc = "Enderun Mezunu: Vezir-i Azam (Sadrazam) Oldun! Devletin 2. adamısın."; ikon = "fa-scroll"; }
            else if(this.guc > this.zeka && this.guc >= 60) { sonuc = "Yeniçeri Ağası Oldun! Padişahın en sadık kılıcısın."; ikon = "fa-khanda"; }
            else { sonuc = "Kapıkulu Askeri (Sipahi/Yeniçeri) oldun. Devletine hizmet ediyorsun."; ikon = "fa-shield-halved"; }

            document.getElementById('devSimulator').innerHTML = `
                <div style="text-align:center; padding:40px;">
                    <i class="fa-solid ${ikon}" style="font-size:4em; color:#E8A020;"></i>
                    <h2>Kariyer Sonucu</h2>
                    <p style="font-size:1.2em; font-weight:bold; color:#27ae60;">${sonuc}</p>
                    <p>Güç: ${this.guc} | Zeka: ${this.zeka} | Liyakat: ${this.liyakat}</p>
                    <button onclick="window.HARITA_MOTORU['harita_u2_arac_devsirme_14']()" style="padding:10px 20px; border:none; background:#2c3e50; color:#fff; border-radius:5px; cursor:pointer;">Yeni Bir Genç Seç</button>
                </div>
            `;
        }
    };
...
// ==========================================
// 15. ARAÇ: DİVAN-I HÜMAYUN: KARAR ODASI (OSMANLI VERSİYONU)
// ==========================================
window.HARITA_MOTORU["harita_u2_arac_divan_15"] = function() {
    ...
    controlsContainer.innerHTML = `
        <div style="text-align: center; color: #F4E4B0;">
            <h3 style="margin:0; color: #E8A020;">Divan-ı Hümayun Simülatörü</h3>
            <p style="font-size: 0.85em; opacity: 0.8; margin:5px 0 0 0;">Devlet meselelerini doğru bürokrata yönlendir!</p>
        </div>
    `;
    controlsContainer.style.display = 'block';
    ...
    mapCanvas.innerHTML = `
        <div id="dvnSimulator" style="width:100%; height:100%; background:#dce4ec; color:#2c3e50; font-family:'Inter', sans-serif; display:flex; flex-direction:column; padding:15px; box-sizing:border-box; overflow-y:auto;">
            <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:15px; background:rgba(255,255,255,0.7); padding:10px; border-radius:10px;">
                <span>Devlet İtibarı: <b id="dvnPuan" style="color:#27ae60;">100</b></span>
                <span>Vaka: <b id="dvnSira">1</b>/5</span>
            </div>
            <div style="background:#fff; border-left:5px solid #2980b9; padding:20px; border-radius:8px; margin-bottom:20px; box-shadow:0 4px 10px rgba(0,0,0,0.1); min-height:90px;">
                <p id="dvnMetin" style="margin:0; font-size:1.1em; font-weight:600; line-height:1.4;">Yükleniyor...</p>
            </div>
            <div style="display:grid; grid-template-columns: 1fr 1fr; gap:10px;">
                <button onclick="window.DIVANOSM_MOTORU.karar('sadrazam')" style="padding:15px 5px; border:none; border-radius:8px; background:#8B1A1A; color:#fff; cursor:pointer;">
                    <b>Vezir-i Azam (Sadrazam)</b><br><small>Padişahın Mutlak Vekili</small>
                </button>
                <button onclick="window.DIVANOSM_MOTORU.karar('kazasker')" style="padding:15px 5px; border:none; border-radius:8px; background:#27ae60; color:#fff; cursor:pointer;">
                    <b>Kazasker</b><br><small>Adalet ve Eğitim (Kadı/Müderris)</small>
                </button>
                <button onclick="window.DIVANOSM_MOTORU.karar('defterdar')" style="padding:15px 5px; border:none; border-radius:8px; background:#C9A84C; color:#fff; cursor:pointer;">
                    <b>Defterdar</b><br><small>Hazine ve Mali İşler</small>
                </button>
                <button onclick="window.DIVANOSM_MOTORU.karar('nisanci')" style="padding:15px 5px; border:none; border-radius:8px; background:#2980b9; color:#fff; cursor:pointer;">
                    <b>Nişancı</b><br><small>Tuğra, Kanun ve Tahrir Defteri</small>
                </button>
            </div>
    ...
    window.DIVANOSM_MOTORU = {
        puan: 100, sira: 0,
        vakalar: [
            { t: "Rumeli'de görev yapan iki kadı arasında yetki karmaşası çıktı. Yeni bir kadı ve medrese hocası ataması yapılmalı. Hangi yetkili ilgilenmeli?", c: "kazasker" },
            { t: "Yeni fethedilen Mora Yarımadası'ndaki araziler has, zeamet ve tımar olarak bölüştürülecek ve deftere (Tahrir) kaydedilecek. Kim yetkilidir?", c: "nisanci" },
            { t: "Padişah sefere çıkamadığı için ordunun başına 'Serdar-ı Ekrem' unvanıyla başkomutan tayin edilmesi gerekiyor. Bu kimin görevidir?", c: "sadrazam" },
            { t: "Cülus bahşişi dağıtılacak ve yeni madeni akçelerin gümüş ayarı ayarlanacak. Hazinenin bütçesini kim denetler?", c: "defterdar" },
            { t: "Yabancı bir ülkeye gönderilecek resmi diplomatik mektuba (nameye) Padişahın Tuğrası çekilecek ve kanunlara uygunluğu denetlenecek. Kime gitmeli?", c: "nisanci" }
        ],
        baslat: function() { this.sira = 0; this.puan = 100; this.goster(); },
        goster: function() {
            if(this.sira >= 5) { this.bitir(); return; }
            document.getElementById('dvnMetin').innerText = this.vakalar[this.sira].t;
            document.getElementById('dvnSira').innerText = this.sira + 1;
            document.getElementById('dvnPuan').innerText = this.puan;
            document.getElementById('dvnGeriBildirim').innerHTML = "";
        },
        karar: function(secim) {
            const dogru = this.vakalar[this.sira].c;
            const gb = document.getElementById('dvnGeriBildirim');
            if(secim === dogru) {
                gb.style.color = "#27ae60"; gb.innerHTML = "Doğru Atama! İşler hızlandı.";
            } else {
                this.puan -= 20;
                gb.style.color = "#8B1A1A"; gb.innerHTML = "Hatalı Atama! Bürokrasi kilitlendi.";
            }
            this.sira++;
            setTimeout(() => this.goster(), 1500);
        },
        bitir: function() {
            let mesaj = this.puan >= 80 ? "Mükemmel Bir Bürokrat!" : "Devlet İşleri Aksadı!";
            document.getElementById('dvnSimulator').innerHTML = `
                <div style="text-align:center; padding:40px;">
                    <i class="fa-solid fa-landmark-dome" style="font-size:4em; color:#C9A84C;"></i>
                    <h2>Divan Dağıldı</h2>
                    <p style="font-size:1.2em; font-weight:bold;">${mesaj}</p>
                    <p>Devlet İtibarı: <b>${this.puan}/100</b></p>
                    <button onclick="window.HARITA_MOTORU['harita_u2_arac_divan_15']()" style="padding:10px 20px; border:none; background:#2c3e50; color:#fff; border-radius:5px; cursor:pointer;">Yeni Oturum</button>
                </div>
            `;
        }
    };
    window.DIVANOSM_MOTORU.baslat();
};

// ==========================================
// 16. ARAÇ: FETRET DEVRİ: ŞEHZADELER SAVAŞI
// ==========================================
window.HARITA_MOTORU["harita_u2_arac_fetret_16"] = function() {
    ...
    controlsContainer.innerHTML = `
        <div style="text-align: center; color: #F4E4B0;">
            <h3 style="margin:0; color: #E8A020;">Fetret Devri Simülatörü</h3>
            <p style="font-size: 0.85em; opacity: 0.8; margin:5px 0 0 0;">Çelebi Mehmet olarak devleti yeniden birleştir!</p>
        </div>
    `;
    controlsContainer.style.display = 'block';
    ...
    mapCanvas.innerHTML = `
        <div id="ftrSimulator" style="width:100%; height:100%; background:#eedfc8; color:#2c3e50; font-family:'Inter', sans-serif; display:flex; flex-direction:column; padding:15px; box-sizing:border-box; overflow-y:auto;">
            <div style="display:grid; grid-template-columns: 1fr 1fr 1fr; gap:10px; margin-bottom:15px;">
                <div style="background:#fff; padding:10px; border-radius:8px; border:2px solid #2980b9; text-align:center;">
                    <i class="fa-solid fa-crown" style="color:#2980b9;"></i><br><small>Otorite</small><br><b id="ftrOto">40</b>
                </div>
                <div style="background:#fff; padding:10px; border-radius:8px; border:2px solid #8B1A1A; text-align:center;">
                    <i class="fa-solid fa-khanda" style="color:#8B1A1A;"></i><br><small>Ordu</small><br><b id="ftrOrdu">30</b>
                </div>
                <div style="background:#fff; padding:10px; border-radius:8px; border:2px solid #27ae60; text-align:center;">
                    <i class="fa-solid fa-scroll" style="color:#27ae60;"></i><br><small>Meşruiyet</small><br><b id="ftrMesru">50</b>
                </div>
            </div>
            <div style="background:#fff; border-left:5px solid #8B1A1A; padding:15px; border-radius:8px; margin-bottom:15px; box-shadow:0 4px 6px rgba(0,0,0,0.1);">
                <small style="color:#8B1A1A; font-weight:bold; text-transform:uppercase;">1402 Sonrası - Karar <span id="ftrAsama">1</span>/4</small>
                <p id="ftrSenaryo" style="margin:10px 0 0 0; font-size:1em; font-weight:500; line-height:1.4;">Yükleniyor...</p>
            </div>
            <div id="ftrButonlar" style="display:flex; flex-direction:column; gap:10px;"></div>
            <div id="ftrGeriBildirim" style="margin-top:15px; text-align:center; font-weight:bold; min-height:40px;"></div>
            <div style="margin-top:auto; font-size:10px; font-weight:bold; color:rgba(0,0,0,0.5); padding-top:10px;">Harita/Araç: Murat Mutlu</div>
        </div>
    `;

    window.FETRET_MOTORU = {
        oto: 40, ordu: 30, mesru: 50, asama: 0,
        senaryolar: [
            {
                t: "Ankara Savaşı kaybedildi. Baban Yıldırım Bayezid esir. Sen Amasya'ya çekildin. Kardeşin İsa Çelebi Bursa'da tahtını ilan etti. Ne yapacaksın?",
                o: [
                    { b: "Hemen ordumu toplayıp Bursa'ya, İsa'nın üzerine yürüyeyim.", d: {o: -10, r: -20, m: 0}, m: "Ordun henüz çok zayıf! Ani saldırı büyük kayıplara yol açtı." },
                    { b: "Amasya'da kalıp gücümü toplayayım ve Anadolu'daki Türkmen beylerinin desteğini alayım.", d: {o: 20, r: 20, m: 10}, m: "Akıllıca! Sabır ve diplomasi ordunu güçlendirdi." }
                ]
            },
            {
                t: "Kardeşin Süleyman Edirne'de (Rumeli'de) tahtını ilan etti ve Bizans ile anlaşarak destek aldı.",
                o: [
                    { b: "Bizans'a ben daha fazla taviz vereyim, beni desteklesinler.", d: {o: -10, r: 0, m: -30}, m: "Hata! Bizans'a taviz vermek Türkmen beylerinin ve ulemanın gözünde meşruiyetini sıfırladı." },
                    { b: "Diğer kardeşim Musa'yı Rumeli'ye gönderip Süleyman'ı yıpratayım.", d: {o: 20, r: 0, m: 10}, m: "Harika strateji! Düşmanlarını birbirine düşürerek merkezde güçlendin." }
                ]
            },
            {
                t: "Timur, Anadolu beyliklerine (Karamanoğulları, Germiyanoğulları) eski topraklarını geri verdi. Beylikler bağımsızlıklarını ilan etti.",
                o: [
                    { b: "Öncelik kardeşlerimdir. Beyliklere şimdilik dokunmayayım, tarafsız kalsınlar.", d: {o: 10, r: 10, m: 10}, m: "Doğru zamanlama. İki cephede savaşmak devleti batırırdı." },
                    { b: "Hepsine savaş açıp babamın sınırlarını hemen geri almalıyım.", d: {o: -30, r: -30, m: -10}, m: "Felaket! Bölünmüş orduyla tüm Anadolu'ya savaş açmak çöküş getirdi." }
                ]
            },
            {
                t: "Musa Çelebi, Süleyman'ı yenip Edirne'ye oturdu ama şimdi de kendi tahtını ilan edip İstanbul'u kuşattı. Son hamle!",
                o: [
                    { b: "Anadolu'daki tüm gücümle Rumeli'ye geçip Musa'ya son darbeyi vurayım.", d: {o: 30, r: 20, m: 20}, m: "Çamurluova Zaferi! Musa'yı mağlup ettin. Tahtın tek sahibisin." },
                    { b: "Rumeli'yi ona bırakayım, ben Anadolu Sultanı olarak kalayım.", d: {o: -40, r: 0, m: -40}, m: "Devlet bölündü! Osmanlı vizyonu bu değildi. Otorite tamamen kayboldu." }
                ]
            }
        ],
        baslat: function() { this.guncelle(); },
        guncelle: function() {
            if(this.asama >= 4 || this.oto <= 0) { this.bitir(); return; }
            const s = this.senaryolar[this.asama];
            document.getElementById('ftrOto').innerText = this.oto;
            document.getElementById('ftrOrdu').innerText = this.ordu;
            document.getElementById('ftrMesru').innerText = this.mesru;
            document.getElementById('ftrAsama').innerText = this.asama + 1;
            document.getElementById('ftrSenaryo').innerText = s.t;
            document.getElementById('ftrGeriBildirim').innerHTML = "";

            const bKutu = document.getElementById('ftrButonlar');
            bKutu.innerHTML = "";
            s.o.forEach(opt => {
                const btn = document.createElement('button');
                btn.style.cssText = "padding:12px; border:none; border-radius:8px; background:#8B1A1A; color:#fff; cursor:pointer; text-align:left; line-height:1.4;";
                btn.innerHTML = `<i class="fa-solid fa-chess-knight" style="color:#F4E4B0;"></i> ${opt.b}`;
                btn.onclick = () => this.kararVer(opt.d, opt.m);
                bKutu.appendChild(btn);
            });
        },
        kararVer: function(degisim, mesaj) {
            this.oto += degisim.o; this.ordu += degisim.r; this.mesru += degisim.m;
            const gb = document.getElementById('ftrGeriBildirim');
            gb.style.color = degisim.o > 0 ? "#27ae60" : "#8B1A1A";
            gb.innerHTML = mesaj;
            document.getElementById('ftrButonlar').innerHTML = "";
            this.asama++;
            setTimeout(() => this.guncelle(), 3000);
        },
        bitir: function() {
            let baslik, ikon;
            if (this.oto > 60 && this.mesru > 60) { baslik = "Devletin 2. Kurucusu: Çelebi Mehmet!"; ikon = "fa-crown
window.HARITA_MOTORU = window.HARITA_MOTORU || {};

// ==========================================
// 17. ARAÇ: BEYLİK DİPLOMASİ ÇARKI (ATB)
// ==========================================
window.HARITA_MOTORU["harita_u2_arac_diplomasi_17"] = function() {
    ...
    controlsContainer.innerHTML = `
        <div style="text-align: center; color: #F4E4B0;">
            ...
            <p style="font-size: 0.85em; opacity: 0.8; margin:5px 0 0 0;">Anadolu Türk Siyasi Birliği'ni zekayla kur!</p>
        </div>
    `;
    controlsContainer.style.display = 'block';
    ...
    mapCanvas.innerHTML = `
        <div id="dipSimulator" style="width:100%; height:100%; background:#e4e9ed; color:#2c3e50; font-family:'Inter', sans-serif; display:flex; flex-direction:column; padding:15px; box-sizing:border-box; overflow-y:auto;">
            <div style="display:grid; grid-template-columns: 1fr 1fr 1fr; gap:10px; margin-bottom:15px;">
                ...
                <div style="background:#fff; padding:10px; border-radius:8px; border:2px solid #C9A84C; text-align:center;">
                    <i class="fa-solid fa-coins" style="color:#C9A84C;"></i><br><small>Hazine (Altın)</small><br><b id="dipHazine">100k</b>
                </div>
                <div style="background:#fff; padding:10px; border-radius:8px; border:2px solid #8B1A1A; text-align:center;">
                    <i class="fa-solid fa-khanda" style="color:#8B1A1A;"></i><br><small>Askeri Güç</small><br><b id="dipOrdu">50k</b>
                </div>
            </div>
            <div style="background:#fff; border-left:5px solid #2980b9; padding:15px; border-radius:8px; margin-bottom:15px; box-shadow:0 4px 6px rgba(0,0,0,0.1);">
                <small style="color:#2980b9; font-weight:bold; text-transform:uppercase;">Diplomatik Hamle <span id="dipAsama">1</span>/4</small>
    ...
    window.DIPLOMASI_MOTORU = {
        birlik: 0, hazine: 100, ordu: 50, asama: 0,
        senaryolar: [
            {
                t: "Karesioğulları Beyliği'nde taht kavgası çıktı. Beylik donanmaya sahip ve Rumeli'ye geçiş için kritik konumda.",
                o: [
                    { b: "İç karışıklığa doğrudan devasa bir orduyla saldırıp hepsini ezelim.", d: {b: 10, h: -20, o: -20}, m: "Maliyetli hata! Türk beyliklerine karşı sert askeri güç kullanmak Anadolu'da tepki çeker." },
                    { b: "Taht kavgasına taraf olup barışçıl yolla ve halkın rızasıyla beyliği ilhak edelim.", d: {b: 25, h: 0, o: 20}, m: "Kusursuz diplomasi! Osmanlı ilk donanmasına kavuştu ve Hacı İlbey, Evrenos Bey gibi değerli komutanları kazandı." }
                ]
            },
            {
                t: "Germiyanoğulları Beyliği, Karamanoğulları'nın baskısı altında. İttifak kurmak istiyorlar.",
                o: [
                    { b: "I. Murat'ın oğlu Yıldırım Bayezid'i Germiyan beyinin kızıyla evlendirerek akrabalık kuralım.", d: {b: 25, h: 10, o: 10}, m: "Çeyiz diplomasisi! Kütahya, Emet, Simav ve Tavşanlı savaşsız olarak Osmanlı'ya geçti." },
                    { b: "Biz onlara koruma sağlayalım ama karşılığında askerlerini bize versinler.", d: {b: 10, h: 0, o: 10}, m: "Toprak kazanımı olmadı. Anadolu birliği hedefine giden yol yavaşladı." }
                ]
            },
            {
                t: "Hamitoğulları Beyliği ekonomik sıkıntı içinde ve Karamanoğulları'nın tehdidinden korkuyor.",
                o: [
                    { b: "Hazineden 80 bin altın vererek Isparta, Yalvaç ve Akşehir çevresini satın alalım.", d: {b: 25, h: -80, o: 10}, m: "Satın Alma diplomasisi! Kan dökmeden çok stratejik bir bölgeyi sınırlarına kattın." },
                    { b: "Zayıf durumdalar, ordumuzla gidip zorla o toprakları ele geçirelim.", d: {b: 10, h: 0, o: -30}, m: "Zalimce hamle! Türkmen halk Osmanlı'ya düşman oldu, ordun gereksiz yıprandı." }
                ]
            },
            {
                t: "Karamanoğulları (Kendilerini Selçuklu'nun varisi görüyorlar) sürekli Osmanlı sınırlarına saldırıp isyan çıkarıyor.",
                o: [
                    { b: "Onlara altın ve toprak vererek barış yapmaya çalışalım.", d: {b: -10, h: -30, o: -10}, m: "Zafiyet! Karaman beyi bunu korkaklık olarak gördü ve saldırılarını artırdı." },
                    { b: "Diplomasi bitti! Yıldırım Bayezid komutasında güçlü bir orduyla kesin itaat altına alalım.", d: {b: 25, h: 0, o: -10}, m: "Sert ve gerekli hamle! Anadolu Türk Siyasi Birliği büyük ölçüde sağlandı." }
                ]
            }
        ],
        baslat: function() { this.guncelle(); },
        guncelle: function() {
            if(this.asama >= 4) { this.bitir(); return; }
            const s = this.senaryolar[this.asama];
            
            document.getElementById('dipBirlik').innerText = "%" + this.birlik;
            document.getElementById('dipHazine').innerText = this.hazine + "k";
            document.getElementById('dipOrdu').innerText = this.ordu + "k";
            document.getElementById('dipAsama').innerText = this.asama + 1;
            document.getElementById('dipSenaryo').innerText = s.t;
            document.getElementById('dipGeriBildirim').innerHTML = "";

            const bKutu = document.getElementById('dipButonlar');
            bKutu.innerHTML = "";
            s.o.forEach(opt => {
                const btn = document.createElement('button');
                btn.style.cssText = "padding:12px; border:none; border-radius:8px; background:#2980b9; color:#fff; cursor:pointer; text-align:left; line-height:1.4;";
                btn.innerHTML = `<i class="fa-solid fa-scroll" style="color:#F4E4B0;"></i> ${opt.b}`;
                btn.onclick = () => this.kararVer(opt.d, opt.m);
                bKutu.appendChild(btn);
            });
        },
        kararVer: function(degisim, mesaj) {
            this.birlik += degisim.b; this.hazine += degisim.h; this.ordu += degisim.o;
            const gb = document.getElementById('dipGeriBildirim');
            gb.style.color = degisim.b >= 20 ? "#27ae60" : "#8B1A1A";
            gb.innerHTML = mesaj;
            document.getElementById('dipButonlar').innerHTML = "";
            this.asama++;
            setTimeout(() => this.guncelle(), 3000);
        },
        bitir: function() {
            let baslik = this.birlik >= 80 ? "Muazzam Birleştirici!" : "Bölünmüş Anadolu";
            let ikon = this.birlik >= 80 ? "fa-earth-asia" : "fa-burst";
            document.getElementById('dipSimulator').innerHTML = `
                <div style="text-align:center; padding:40px;">
                    <i class="fa-solid ${ikon}" style="font-size:4em; color:#27ae60;"></i>
                    <h2>${baslik}</h2>
                    <p>Siyasi Birlik: <b>%${this.birlik}</b></p>
                    <button onclick="window.HARITA_MOTORU['harita_u2_arac_diplomasi_17']()" style="padding:10px 20px; border:none; background:#2c3e50; color:#fff; border-radius:5px; cursor:pointer;">Yeniden Strateji Kur</button>
                </div>
            `;
        }
    };
...
// ==========================================
// 18. ARAÇ: OSMANLI ORDU YAPISI (Sınıflandırma Motoru)
// ==========================================
window.HARITA_MOTORU["harita_u2_arac_ordu_18"] = function() {
    ...
    controlsContainer.innerHTML = `
        <div style="text-align: center; color: #F4E4B0;">
            <h3 style="margin:0; color: #E8A020;">Osmanlı Ordu Sınıflandırması</h3>
            <p style="font-size: 0.85em; opacity: 0.8; margin:5px 0 0 0;">Ekrana gelen askeri doğru sınıfa yerleştir!</p>
        </div>
    `;
    controlsContainer.style.display = 'block';
    ...
    mapCanvas.innerHTML = `
        <div id="orduSimulator" style="width:100%; height:100%; background:#d4e1ce; color:#2c3e50; font-family:'Inter', sans-serif; display:flex; flex-direction:column; padding:15px; box-sizing:border-box; overflow-y:auto;">
            <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:10px; background:rgba(255,255,255,0.7); padding:10px; border-radius:10px;">
                <span>Puan: <b id="orduPuan" style="color:#27ae60;">0</b></span>
                <span>Asker: <b id="orduSira">1</b>/6</span>
            </div>
            
            <div style="flex-grow:1; display:flex; align-items:center; justify-content:center; flex-direction:column; background:#fff; border-radius:15px; padding:20px; box-shadow:0 4px 10px rgba(0,0,0,0.1); margin-bottom:20px; text-align:center;">
                <i class="fa-solid fa-person-military-rifle" style="font-size:4em; color:#8B1A1A; margin-bottom:15px;"></i>
                <h2 id="orduAskerAdi" style="margin:0 0 10px 0; color:#2c3e50;">Yükleniyor...</h2>
                <p id="orduAskerBilgi" style="font-size:0.9em; color:#555; font-style:italic;">...</p>
            </div>

            <div style="display:grid; grid-template-columns: 1fr 1fr; gap:10px;">
                <button onclick="window.ORDU_MOTORU.cevapla('kapikulu')" style="padding:15px; border:none; border-radius:8px; background:#8B1A1A; color:#fff; font-weight:bold; cursor:pointer;">
                    <i class="fa-solid fa-chess-rook"></i> KAPIKULU ORDUSU<br><small>(Merkez/Ulufe/Devşirme)</small>
                </button>
                <button onclick="window.ORDU_MOTORU.cevapla('eyalet')" style="padding:15px; border:none; border-radius:8px; background:#27ae60; color:#fff; font-weight:bold; cursor:pointer;">
                    <i class="fa-solid fa-horse"></i> EYALET ORDUSU<br><small>(Taşra/Tımar/Türkmen)</small>
                </button>
            </div>
            
            <div id="orduGeriBildirim" style="margin-top:15px; text-align:center; font-weight:bold; height:30px;"></div>
            <div style="margin-top:auto; font-size:10px; font-weight:bold; color:rgba(0,0,0,0.5); padding-top:10px;">Harita/Araç: Murat Mutlu</div>
        </div>
    `;
    ...
    window.ORDU_MOTORU = {
        puan: 0, sira: 0,
        askerler: [
            { ad: "Yeniçeri", bilgi: "3 ayda bir Ulufe maaşı alırım. Devşirme kökenliyim. Savaşta Padişahın otağını korurum.", tip: "kapikulu" },
            { ad: "Tımarlı Sipahi", bilgi: "Maaş almam, tımar toprağının geliriyle geçinirim. Türk kökenliyim. Savaşta kanatlarda yer alırım.", tip: "eyalet" },
            { ad: "Akıncı", bilgi: "Sınır boylarında yaşarım. Ordunun keşif hizmetini yapar, düşman topraklarına akınlar düzenlerim.", tip: "eyalet" },
            { ad: "Cebeci", bilgi: "Ordunun ok, yay, kılıç, tüfek gibi silahlarını yapar ve tamir ederim. Merkez ordusundayım.", tip: "kapikulu" },
            { ad: "Azap", bilgi: "Bekar ve dinç Türk gençlerinden oluşurum. Savaşta ordunun en ön safında yer alır, ilk hücumu yaparım.", tip: "eyalet" },
            { ad: "Topçu Ocağı", bilgi: "Kuşatmalarda devasa şahi toplarını döker ve kullanırım. Devlet hazinesinden Ulufe maaşı alırım.", tip: "kapikulu" }
        ],
        baslat: function() { this.askerler = this.askerler.sort(() => Math.random() - 0.5); this.sira = 0; this.puan = 0; this.goster(); },
        goster: function() {
            if(this.sira >= 6) { this.bitir(); return; }
            const a = this.askerler[this.sira];
            document.getElementById('orduAskerAdi').innerText = a.ad;
            document.getElementById('orduAskerBilgi').innerText = `"${a.bilgi}"`;
            document.getElementById('orduSira').innerText = this.sira + 1;
            document.getElementById('orduPuan').innerText = this.puan;
        },
        cevapla: function(secim) {
            const dogru = this.askerler[this.sira].tip;
            const gb = document.getElementById('orduGeriBildirim');
            if(secim === dogru) {
                this.puan += 20;
                gb.style.color = "#27ae60"; gb.innerHTML = "<i class='fa-solid fa-check'></i> Doğru Sınıflandırma!";
            } else {
                gb.style.color = "#8B1A1A"; gb.innerHTML = "<i class='fa-solid fa-xmark'></i> Yanlış Birlik!";
            }
            this.sira++;
            setTimeout(() => { gb.innerHTML = ""; this.goster(); }, 1500);
        },
        bitir: function() {
            document.getElementById('orduSimulator').innerHTML = `
                <div style="text-align:center; padding:40px;">
                    <i class="fa-solid fa-shield" style="font-size:4em; color:#2c3e50;"></i>
                    <h2>Teftiş Tamamlandı</h2>
                    <p>Ordu Bilgi Puanın: <b style="font-size:1.5em; color:#27ae60;">${this.puan}/120</b></p>
                    <button onclick="window.HARITA_MOTORU['harita_u2_arac_ordu_18']()" style="padding:10px 20px; border:none; background:#2c3e50; color:#fff; border-radius:5px; cursor:pointer;">Yeniden Teftiş Et</button>
                </div>
            `;
        }
    };
    window.ORDU_MOTORU.baslat();
};

// ==========================================
// 19. ARAÇ: VAKIF ŞEHİR: BURSA MİMARI
// ==========================================
window.HARITA_MOTORU["harita_u2_arac_bursa_19"] = function() {
    ...
    controlsContainer.innerHTML = `
        <div style="text-align: center; color: #F4E4B0;">
            ...
            <p style="font-size: 0.85em; opacity: 0.8; margin:5px 0 0 0;">Bursa'yı devlete yakışır bir İslam başkenti yap!</p>
        </div>
    `;
    controlsContainer.style.display = 'block';
    ...
    mapCanvas.innerHTML = `
        <div id="brsSimulator" style="width:100%; height:100%; background:#e9e4d4; color:#2c3e50; font-family:'Inter', sans-serif; display:flex; flex-direction:column; padding:15px; box-sizing:border-box; overflow-y:auto;">
            <div style="display:grid; grid-template-columns: 1fr 1fr; gap:10px; margin-bottom:15px;">
                <div style="background:#fff; padding:10px; border-radius:8px; border:2px solid #8B1A1A; text-align:center;">
                    <i class="fa-solid fa-coins" style="color:#8B1A1A;"></i><br><small>Hazine (Akar)</small><br><b id="brsAkar">150</b>
                </div>
                <div style="background:#fff; padding:10px; border-radius:8px; border:2px solid #27ae60; text-align:center;">
                    <i class="fa-solid fa-city" style="color:#27ae60;"></i><br><small>Bayındırlık Puanı</small><br><b id="brsBayindir">0</b>
                </div>
            </div>

            <div id="brsAlan" style="flex-grow:1; background:url('https://www.transparenttextures.com/patterns/aged-paper.png') #dcd1ba; border:2px dashed #a0937d; border-radius:15px; position:relative; margin-bottom:15px; display:flex; flex-wrap:wrap; align-content:center; justify-content:center; gap:10px; padding:15px;">
                <h4 style="position:absolute; top:5px; margin:0; opacity:0.5;">Bursa Ulu Cami ve Çevresi</h4>
            </div>

            <div style="display:grid; grid-template-columns: 1fr 1fr; gap:8px;">
                <button onclick="window.BURSA_MOTORU.insaEt('ipekhan')" style="padding:10px; border:none; border-radius:8px; background:#8B1A1A; color:#fff; cursor:pointer; font-size:0.85em;">
                    <i class="fa-solid fa-shop"></i> İpek Hanı Yap<br><small>(Maliyet:50 | Gelir:+30)</small>
                </button>
                <button onclick="window.BURSA_MOTORU.insaEt('ulucami')" style="padding:10px; border:none; border-radius:8px; background:#2980b9; color:#fff; cursor:pointer; font-size:0.85em;">
                    <i class="fa-solid fa-mosque"></i> Ulu Cami İnşa Et<br><small>(Maliyet:80 | Bayındırlık:+40)</small>
                </button>
                <button onclick="window.BURSA_MOTORU.insaEt('medrese')" style="padding:10px; border:none; border-radius:8px; background:#27ae60; color:#fff; cursor:pointer; font-size:0.85em;">
                    <i class="fa-solid fa-book-open"></i> Medrese Kur<br><small>(Maliyet:60 | Bayındırlık:+30)</small>
                </button>
                <button onclick="window.BURSA_MOTORU.insaEt('darussifa')" style="padding:10px; border:none; border-radius:8px; background:#d35400; color:#fff; cursor:pointer; font-size:0.85em;">
                    <i class="fa-solid fa-hospital"></i> Darüşşifa (Şifahane)<br><small>(Maliyet:70 | Bayındırlık:+35)</small>
                </button>
            </div>
            
            <div id="brsMesaj" style="margin-top:10px; text-align:center; font-size:0.9em; font-weight:bold; color:#8B1A1A; height:20px;">Orhan Gazi'nin vizyonuyla şehri kurmaya başla! (Önce gelir getiren 'Han' yapılmalı)</div>
            <div style="margin-top:10px; font-size:10px; font-weight:bold; color:rgba(0,0,0,0.5);">Harita/Araç: Murat Mutlu</div>
        </div>
    `;
    ...
    window.BURSA_MOTORU = {
        akar: 150, bayindir: 0,
        yapilar: {
            ipekhan: { ad: "İpek Hanı", ikon: "fa-shop", maliyet: 50, akarEkle: 40, bayEkle: 10, renk: "#8B1A1A", yapildi: false },
            ulucami: { ad: "Ulu Cami", ikon: "fa-mosque", maliyet: 80, akarEkle: -10, bayEkle: 40, renk: "#2980b9", yapildi: false },
            medrese: { ad: "Medrese", ikon: "fa-book-open", maliyet: 60, akarEkle: -15, bayEkle: 30, renk: "#27ae60", yapildi: false },
            darussifa: { ad: "Darüşşifa", ikon: "fa-hospital", maliyet: 70, akarEkle: -20, bayEkle: 35, renk: "#d35400", yapildi: false }
        },
        insaEt: function(tip) {
            const y = this.yapilar[tip];
            const msg = document.getElementById('brsMesaj');
            if(y.yapildi && tip === 'ulucami') { msg.innerText = "Ulu Cami zaten inşa edildi!"; return; }
            
            if(this.akar >= y.maliyet) {
                this.akar = this.akar - y.maliyet + y.akarEkle;
                this.bayindir += y.bayEkle;
                y.yapildi = true;
                
                const alan = document.getElementById('brsAlan');
                const div = document.createElement('div');
                div.style.cssText = `width:75px; height:75px; background:${y.renk}; color:#fff; border-radius:10px; display:flex; flex-direction:column; align-items:center; justify-content:center; font-size:0.7em; box-shadow:0 4px 6px rgba(0,0,0,0.2); transition:transform 0.3s;`;
                div.innerHTML = `<i class="fa-solid ${y.ikon}" style="font-size:1.6em; margin-bottom:5px;"></i><b>${y.ad}</b>`;
                alan.appendChild(div);
                
                msg.style.color = "#27ae60"; msg.innerText = y.ad + " başarıyla inşa edildi!";
                this.guncelle();
            } else {
                msg.style.color = "#8B1A1A"; msg.innerText = "Yetersiz Hazine! Önce gelir getiren Han/Bedesten inşa etmelisin.";
            }
            if(this.bayindir >= 115) this.bitir();
        },
        guncelle: function() {
        ...
        bitir: function() {
            document.getElementById('brsSimulator').innerHTML = `
                <div style="text-align:center; padding:40px;">
                    <i class="fa-solid fa-city" style="font-size:4em; color:#27ae60;"></i>
                    <h2>Bursa Yeniden Doğdu!</h2>
                    <p>Bir Bizans tekfurluğunu, camileri, hanları ve medreseleriyle muazzam bir Osmanlı başkentine dönüştürdün.</p>
                    <p>Şehirleşme Puanı: <b>${this.bayindir}</b></p>
                    <button onclick="window.HARITA_MOTORU['harita_u2_arac_bursa_19']()" style="padding:10px 20px; border:none; background:#2c3e50; color:#fff; border-radius:5px; cursor:pointer;">Yeniden Oyna</button>
                </div>
            `;
        }
    };
    window.BURSA_MOTORU.guncelle();
};

// ==========================================
// 20. ARAÇ: TARİHİN KIRILMA NOKTASI: 1402 ANALİZİ
// ==========================================
window.HARITA_MOTORU["harita_u2_arac_1402_20"] = function() {
    ...
    controlsContainer.innerHTML = `
        <div style="text-align: center; color: #F4E4B0;">
            ...
            <p style="font-size: 0.85em; opacity: 0.8; margin:5px 0 0 0;">Ankara Savaşı'nın nedenlerini doğru kategorize et.</p>
        </div>
    `;
    controlsContainer.style.display = 'block';
    ...
    mapCanvas.innerHTML = `
        <div id="ankSimulator" style="width:100%; height:100%; background:#f2f2f2; color:#2c3e50; font-family:'Inter', sans-serif; display:flex; flex-direction:column; padding:15px; box-sizing:border-box; overflow-y:auto;">
            <div id="ankGeriBildirim" style="text-align:center; font-weight:bold; min-height:35px; margin-bottom:10px; display:flex; align-items:center; justify-content:center; border-radius:8px;"></div>
            
            <div style="background:#fff; border-top:4px solid #E8A020; padding:20px; border-radius:8px; margin-bottom:15px; box-shadow:0 4px 10px rgba(0,0,0,0.1); position:relative; min-height:100px; display:flex; align-items:center; justify-content:center;">
                <p id="ankMetni" style="font-style:italic; font-weight:500; text-align:center; line-height:1.5; margin:0;">Yükleniyor...</p>
            </div>
            
            <p style="text-align:center; font-size:0.85em; font-weight:bold; margin-bottom:10px; color:#8B1A1A; text-transform:uppercase;">Bu İfadenin Temel Nedeni Nedir?</p>
            <div style="display:grid; grid-template-columns: 1fr; gap:10px;">
                <button onclick="window.ANKARA_MOTORU.analiz('siyasi')" style="padding:15px; border:none; border-radius:8px; background:#2980b9; color:#fff; font-weight:bold; cursor:pointer;">
                    <i class="fa-solid fa-crown"></i> SİYASİ NEDEN
                </button>
                <button onclick="window.ANKARA_MOTORU.analiz('ekonomik')" style="padding:15px; border:none; border-radius:8px; background:#27ae60; color:#fff; font-weight:bold; cursor:pointer;">
                    <i class="fa-solid fa-coins"></i> EKONOMİK NEDEN
                </button>
                <button onclick="window.ANKARA_MOTORU.analiz('askeri')" style="padding:15px; border:none; border-radius:8px; background:#8B1A1A; color:#fff; font-weight:bold; cursor:pointer;">
                    <i class="fa-solid fa-khanda"></i> ASKERİ / STRATEJİK NEDEN
                </button>
            </div>
    ...
    window.ANKARA_MOTORU = {
        skor: 0, sira: 0,
        havuz: [
            { t: "Topraklarını kaybeden Anadolu Türkmen beylerinin Timur'a sığınarak onu kışkırtması.", c: "siyasi" },
            { t: "İki hükümdarın da İpek Yolu güzergahını ve doğu-batı ticaretini tekeline almak istemesi.", c: "ekonomik" },
            { t: "Timur'un fillere sahip olması ve Osmanlı ordusundaki Kara Tatarların savaş sırasında saf değiştirmesi.", c: "askeri" },
            { t: "İki hükümdarın da 'Cihan Hakimiyeti' (Dünyayı tek elden yönetme) mefkûresine sahip olması.", c: "siyasi" },
            { t: "Timur'un ordusunun su kuyularını önceden tutarak Osmanlı ordusunu susuz bırakması.", c: "askeri" }
        ],
        baslat: function() { this.havuz = this.havuz.sort(() => Math.random() - 0.5); this.sira = 0; this.skor = 0; this.goster(); },
        goster: function() {
            if(this.sira >= 5) { this.bitir(); return; }
            document.getElementById('ankMetni').innerText = this.havuz[this.sira].t;
            document.getElementById('ankGeriBildirim').innerHTML = "";
            document.getElementById('ankGeriBildirim').style.background = "transparent";
        },
        analiz: function(secim) {
            ...
            if(secim === dogru) {
                this.skor += 20;
                gb.style.color = "#fff"; gb.style.background = "#27ae60"; gb.innerHTML = "<i class='fa-solid fa-circle-check'></i> DOĞRU TESPİT";
            } else {
                gb.style.color = "#fff"; gb.style.background = "#8B1A1A"; gb.innerHTML = "<i class='fa-solid fa-circle-xmark'></i> YANLIŞ KATEGORİ";
            }
            this.sira++;
            setTimeout(() => this.goster(), 1500);
        },
        bitir: function() {
            document.getElementById('ankSimulator').innerHTML = `
                <div style="text-align:center; padding:40px;">
                    <i class="fa-solid fa-magnifying-glass-chart" style="font-size:4em; color:#2c3e50;"></i>
                    <h2>1402 Raporu Hazır</h2>
                    <p>Dedektiflik Puanı: <b style="font-size:1.5em; color:#27ae60;">${this.skor}/100</b></p>
                    <button onclick="window.HARITA_MOTORU['harita_u2_arac_1402_20']()" style="padding:10px 20px; border:none; background:#2c3e50; color:#fff; border-radius:5px; cursor:pointer;">Yeniden Analiz Et</button>
                </div>
            `;
        }
    };
    window.ANKARA_MOTORU.baslat();
};